...
public class Arreglo1 extends javax.swing.JInternalFrame {
    ...
    private void bSetTamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSetTamActionPerformed
        ...
        try {
            ...
            int size = Integer.parseInt(this.tfTam.getText());
            
            JOptionPane.showMessageDialog(this, "Tamaño será: " + size, "Tamaño",
    ...
    private void bAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarActionPerformed
        // TODO add your handling code here:
        //MArreglo1 obj = new MArreglo1();
        
        try {
            MArreglo1 obj = new MArreglo1();
            
            int tam = Integer.parseInt(this.tfTam.getText());

            //obj.setSizeArray(tam);

            int mult = Integer.parseInt(this.tfMultiplo.getText());
            
            ArrayList<Integer> arreglo = new ArrayList<>();
            
            int elem = Integer.parseInt(this.tfElemento.getText());
            
            if(obj.esMultiplo(mult, elem)) {
                JOptionPane.showMessageDialog(this, "" + 
                        elem + " es multiplo de " + mult + ", se agregará...", 
                        "Agregar elemento", JOptionPane.INFORMATION_MESSAGE);
                ...
                JOptionPane.showMessageDialog(this, "" + 
                        elem + " NO es multiplo de " + mult + ", NO se agregará...", 
                        "Agregar elemento", JOptionPane.WARNING_MESSAGE);
            }
