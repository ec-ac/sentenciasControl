...
public class Logicos extends javax.swing.JInternalFrame {
    ...
    private void bVerificar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar1ActionPerformed
        ...
        try {
            MLogico obj = new MLogico();
            
            double number1 = Double.parseDouble(this.tfNum1.getText());
            double number2 = Double.parseDouble(this.tfNum2.getText());
            
            boolean check = obj.verificarMismos(number1, number2);
    ...
    private void bCalcular2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular2ActionPerformed
        ...
        try {
            ...
            double number1 = Double.parseDouble(this.tfNum3.getText());
            double number2 = Double.parseDouble(this.tfNum4.getText());
            
            double numeroMayor = obj.encontrarMayor(number1, number2);
            
            JOptionPane.showMessageDialog(this, "El numero mayor es: "
                    + numeroMayor, "Respuesta", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void bCalcular3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular3ActionPerformed
        ...
        try {
            ...
            double number1 = Double.parseDouble(this.tfNum5.getText());
            double number2 = Double.parseDouble(this.tfNum6.getText());
            
            double numeroMenor = obj.encontrarMenor(number1, number2);
            
            JOptionPane.showMessageDialog(this, "El numero menor es: "
                    + numeroMenor, "Respuesta", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void bCalcular4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular4ActionPerformed
        ...
        try {
            ...
            double number1 = Double.parseDouble(this.tfNum7.getText());
            double number2 = Double.parseDouble(this.tfNum8.getText());
            
            boolean check = obj.valorVerdaderoMayor(number1, number2);
            
            if(check) {
                JOptionPane.showMessageDialog(this, "Sentencia verdadera",
                        "Respuesta", JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(this, "Sentencia NO verdadera",
                        "Respuesta", JOptionPane.WARNING_MESSAGE);
            }
    ...
    private void bCalcular5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular5ActionPerformed
        ...
        try {
            ...
            double number1 = Double.parseDouble(this.tfNum9.getText());
            double number2 = Double.parseDouble(this.tfNum10.getText());
            
            boolean check = obj.valorVerdaderoMenor(number1, number2);
    ...
    private void bVerificar6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar6ActionPerformed
        ...
        try {
            ...
            char caracter1 = (this.tfCaracter1.getText()).charAt(0);
            char caracter2 = (this.tfCaracter2.getText()).charAt(0);
            
            boolean check = obj.caracteresIguales(caracter1, caracter2);
            
            if(check) {
                JOptionPane.showMessageDialog(this, "Caracteres son iguales",
                        "Respuesta", JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(this, "Caracteres NO son iguales",
                        "Respuesta", JOptionPane.WARNING_MESSAGE);
            }
    ...
    private void bVerificar7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar7ActionPerformed
        ...
        try {
            ...
            char caracter1 = (this.tfCaracter3.getText()).charAt(0);
            char caracter2 = (this.tfCaracter4.getText()).charAt(0);
            
            boolean check = obj.caracteresDistintos(caracter1, caracter2);
            
            if(check) {
                JOptionPane.showMessageDialog(this, "Caracteres son distintos",
                        "Respuesta", JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(this, "Caracteres NO son distintos",
                        "Respuesta", JOptionPane.WARNING_MESSAGE);
            }
    ...
    private void bVerificar8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar8ActionPerformed
        ...
        try {
            ...
            String string1 = this.tfCadena1.getText();
            String string2 = this.tfCadena2.getText();
            
            boolean check = obj.cadenasIguales(string1, string2);
            
            if(check) {
                JOptionPane.showMessageDialog(this, "Cadenas son iguales",
                        "Respuesta", JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(this, "Cadenas NO son iguales",
                        "Respuesta", JOptionPane.WARNING_MESSAGE);
            }
    ...
    private void bCalcular9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular9ActionPerformed
        ...
        try {
            ...
            String string1 = this.tfCadena3.getText();
            String string2 = this.tfCadena4.getText();
            
            int lenMayor = obj.cadenaMayor(string1, string2);
            
            if (string1.length() == lenMayor) {
                JOptionPane.showMessageDialog(this, "Cadena Mayor: \"" + string1 
                        + "\" (" + lenMayor + ")", "Respuesta", 
                        JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(this, "Cadena Mayor: \"" + string2 
                        + "\" (" + lenMayor + ")", "Respuesta", 
                        JOptionPane.INFORMATION_MESSAGE);
            }
    ...
    private void bVerificar10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar10ActionPerformed
        ...
        try {
            ...
            double number = Double.parseDouble(this.tfNum11.getText());
            
            boolean check = obj.numeroPositivo(number);
            
            if(check) {
                JOptionPane.showMessageDialog(this, 
                        "El numero ingresado es positivo", "Respuesta", JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(this, 
                        "El numero ingresado es negativo o no-negativo", "Respuesta", JOptionPane.WARNING_MESSAGE);
            }
