...
public class While extends javax.swing.JInternalFrame {
    ...
    MWhile obj = new MWhile();
    
    MWhile obj2 = new MWhile();
    ...
    private void bVerificar3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar3ActionPerformed
        ...
        try{
            MWhile si = new MWhile();
            
            int num = Integer.parseInt(this.tfNum3.getText());
            
            boolean flag = si.perfect(num);
            
            if (flag)
                JOptionPane.showMessageDialog(this, "Este numero es perfecto");
            else 
                JOptionPane.showMessageDialog(this, "Este numero no es perfecto");
    ...
    private void bSumar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSumar2ActionPerformed
        // TODO add your handling code here:
        try {
            double valor = Double.parseDouble(this.tfNum2.getText());
            
            while(valor != -1) {
                obj.agregarSuma(valor);
                JOptionPane.showMessageDialog(this, 
                        "Se agrego " + valor + " a la suma", 
                        "Sumando", JOptionPane.INFORMATION_MESSAGE);
                break;
            }
            
            if(valor == -1) {
                JOptionPane.showMessageDialog(this,
                "La suma de los valores ingresados == " + obj.getSuma(),"Respuesta",
    ...
    private void bContar4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bContar4ActionPerformed
        try{
            double valor = Double.parseDouble(this.tfCali4.getText());
            
            while(valor != -1) {
                if (valor > 70) {
                    obj.agregarSuma(1);
                    JOptionPane.showMessageDialog(this, 
                        "Se agrego una nota aprobada a la suma", 
                        "Sumando", JOptionPane.INFORMATION_MESSAGE);
                }
                break;
            }
            ...
            if(valor == -1) {
                JOptionPane.showMessageDialog(this,
                "La cantidad de notas aprobadas == " + obj.getSuma(),"Respuesta",
                JOptionPane.INFORMATION_MESSAGE);
    ...
    private void bCalcular1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular1ActionPerformed
        ...
        try {
            ...
            String sentence = this.tfOracion1.getText();
            
            int check = obj2.vowelCheck(sentence);
            
            JOptionPane.showMessageDialog(this, "La cantidad de vocales en esta oracion es: " + check);
    ...
    private void bPagar5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bPagar5ActionPerformed
        // TODO add your handling code here:
        try{
            double valor = Double.parseDouble(this.tfCuota5.getText());
            
            while(obj.getSuma() < 1000) {
                obj.agregarSuma(valor);
                obj.agregarCount(1);
                JOptionPane.showMessageDialog(this, 
                        "Se resto " + valor + " a la deuda", 
                        "Sumando", JOptionPane.INFORMATION_MESSAGE);
                break;
            }
            ...
            if(obj.getSuma() >= 1000) {
                JOptionPane.showMessageDialog(this,
                "La cantidad de cuotas pagadas == " + obj.getCount(),"Respuesta",
                JOptionPane.INFORMATION_MESSAGE);
