...
public class Aritmeticos extends javax.swing.JInternalFrame {
    ...
    private void bVerificar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar1ActionPerformed
        ...
        try {
            MAritmeticos obj = new MAritmeticos();
            
            int number1 = Integer.parseInt(this.tfNum1.getText());
            int number2 = Integer.parseInt(this.tfNum2.getText());
            
            boolean check1 = obj.esMultiplo(number1, number2);
            boolean check2 = obj.esMultiplo(number2, number1);
            
            if(check1) {
                JOptionPane.showMessageDialog(this, "" + 
                        number2 + " es multiplo de " + number1,
                        "Respuesta", JOptionPane.INFORMATION_MESSAGE);
                
                //si son iguales, se sale para no mostrar la misma ventana dos veces
                if(number1 == number2)
                    return;
            ...
            if(check2) {
                JOptionPane.showMessageDialog(this, "" + 
                        number1 + " es multiplo de " + number2,
                        "Respuesta", JOptionPane.INFORMATION_MESSAGE);
            } else if (!check1 && !check2) {
                JOptionPane.showMessageDialog(this, "Ninguno es multiplo del otro" ,
    ...
    private void bCalcular4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular4ActionPerformed
        ...
        try {
            ...
            double number1 = Double.parseDouble(this.tfNum13.getText());
            double number2 = Double.parseDouble(this.tfNum14.getText());
            
            double displayValue = obj.valorPow(number1, number2);
            
            JOptionPane.showMessageDialog(this, "x^a  = " + displayValue,
                    "Respuesta", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void bCalcular5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular5ActionPerformed
        ...
        try {
            ...
            double number1 = Double.parseDouble(this.tfNum15.getText());
            double number2 = Double.parseDouble(this.tfNum16.getText());
            double number3 = Double.parseDouble(this.tfNum17.getText());
            
            double displayValue = (obj.valorPow(number1, number2)) * (number2/number3);
            
            JOptionPane.showMessageDialog(this, "(x^a) * (a/b)  = " + displayValue,
                    "Respuesta", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void bCalcular2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular2ActionPerformed
        ...
        try {
            ...
            double number3 = Double.parseDouble(this.tfNum5.getText());
            double number4 = Double.parseDouble(this.tfNum6.getText());
            double number5 = Double.parseDouble(this.tfNum7.getText());
            
            double displayValue = number1 + number2 - number3 * number4 / number5;
            
            JOptionPane.showMessageDialog(this, "Respuesta = " + displayValue,
                    "Respuesta", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void bCalcular3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular3ActionPerformed
        ...
        try {
            ...
            double number1 = Double.parseDouble(this.tfNum8.getText());
            double number2 = Double.parseDouble(this.tfNum9.getText());
            double number3 = Double.parseDouble(this.tfNum10.getText());
            double number4 = Double.parseDouble(this.tfNum11.getText());
            double number5 = Double.parseDouble(this.tfNum12.getText());
