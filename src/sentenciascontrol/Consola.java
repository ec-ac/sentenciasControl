...
public class Consola extends javax.swing.JInternalFrame {
    ...
    private void bRealizar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bRealizar2ActionPerformed
        ...
        try {
            ...
            System.out.println("Ingrese dos numeros para encontrar el residuo de la división entre ellos: ");
    ...
    private void bRealizar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bRealizar1ActionPerformed
        ...
        try {
            ...
            numeroEnBytes = numero * bytesConversion; //los numeros son demasiado grandes, solo voy a usar scientific notation
            
            System.out.println("La cantidad de bytes es: " + numeroEnBytes + "* 10^12");
            
            JOptionPane.showMessageDialog(this, "La cantidad de bytes es: " + numeroEnBytes + "* 10^12");
    ...
    private void bRealizar6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bRealizar6ActionPerformed
       try {
            JOptionPane.showMessageDialog(this, "No se que quiere decir esto");
    ...
    private void bRealizar8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bRealizar8ActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Fecha actual del sistema: " + fechaSistema, "Fecha del Sistema", JOptionPane.INFORMATION_MESSAGE);
